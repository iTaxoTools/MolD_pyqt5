"""
This script contains updated functions and mainprocessing of MolD_v1.3
This script compiles rDNC-based DNA diagnoses for a pre-defined taxa in a dataset. This is the MAIN WORKING VERSION re-written for Python3
...
def mainprocessing(gapsaschars=None, taxalist=None, taxonrank=None, cutoff=None, numnucl=None, numiter=None, maxlenraw=None, maxlenrefined=None, pdiff=None, nmax=None, thresh=None, tmpfname=None, origfname=None, output=None):
    ParDict = {}
